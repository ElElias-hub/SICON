<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SICON.Pll.Index" %>
    ...
    <ul class="navbar-nav ml-auto nav-flex-icons">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-default"
          ...
          <asp:Label ID="UserLbl" runat="server" Text="Label" class="dropdown-item"></asp:Label>
          ...
          <asp:Button ID="ControlBtn" runat="server" Text="Panel de control" class="dropdown-item" OnClick="ControlBtn_Click"/>
            ...
            <asp:Button ID="RegistrarBtn" runat="server" Text="Registrate" class="dropdown-item"/>
